...
struct NotificationModel {
    ...
    init(snapshot: FIRDataSnapshot) {
        ...
        self.title = UTILITY_SERVICE.exist(field: NotificationModel.kNotificationTitlekey, dictionary: snapshotValue)
        self.timestamp = UTILITY_SERVICE.exist(field: NotificationModel.kNotificationDatekey, dictionary: snapshotValue)
        self.seen = snapshotValue.object(forKey: "seen") as! Bool
        self.photoURL = UTILITY_SERVICE.exist(field: NotificationModel.kNotificationPhotokey, dictionary: snapshotValue)
