...
class testFile {
    ...
    func testDate() -> [DateModel] {
        ...
        dateArray.append(DateModel(title: "Junta Familiar", description: "Ninguna", date: "2017 03 24", hour: "9:45", priority: 3, members: [""]))
        dateArray.append(DateModel(title: "Tomar Pastilla", description: "Paracetamol", date: "2017 03 23", hour: "10:00", priority: 2, members: [""]))
        dateArray.append(DateModel(title: "Tomar Pastilla", description: "Paracetamol", date: "2017 03 24", hour: "10:00", priority: 2, members: [""]))
        dateArray.append(DateModel(title: "Tomar Pastilla", description: "Paracetamol", date: "2017 03 25", hour: "10:00", priority: 2, members: [""]))
